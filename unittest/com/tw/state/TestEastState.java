...
public class TestEastState {
	...
	public void testHandleLeft() {
		...
		EastState eastState = new EastState(rover1);
		eastState.handleLeft(marsContext);
	}
	...
	public void testHandleRight() {
		...
		marsContext.setRover(rover1);
		EastState eastState = new EastState(rover1);
		eastState.handleRight(marsContext);
	}
	...
	public void testHandleMove() {
		...
		marsContext.setRover(rover1);
		EastState eastState = new EastState(rover1);
		eastState.handleMove(marsContext);
	}
